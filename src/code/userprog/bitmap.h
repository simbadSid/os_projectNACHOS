...
// +b simbadSid 15.01.2015
    int FindAndMark ();						// Return the # of a clear bit, and as a side effect, set the bit. If no bits are clear, return -1.
	int FindFirst (int nbrBits);			// Return the # of the first nbrBits clear bits.
	int FindLast(int nbrBits);				// Return the # of the last nbrBits clear bits.
